...
def build_parser() -> argparse.ArgumentParser:
    ...
    rc.add_argument("--provider", default="zai")
    rc.add_argument("--model", default="glm-4.5-flash")
    rc.add_argument("--thinking", default="off")
    rc.add_argument("--max-workers", type=int, default=2)
    rc.add_argument("--json", action="store_true")

    op_s = sub.add_parser("op-search")
    op_s.add_argument("prompt")
    op_s.add_argument("--top-k", type=int, default=20)
    op_s.add_argument("--min-seed-count", type=int, default=5)
    op_s.add_argument("--crossref-rows", type=int, default=30)
    op_s.add_argument("--sort", default="RelevanceScore")
    op_s.add_argument("--sigma-model", default="auto")
    op_s.add_argument("--discipline", default="ET")
    op_s.add_argument("--provider")
    op_s.add_argument("--model")
    op_s.add_argument("--thinking")
    op_s.add_argument("--wait-seconds", type=int, default=30)
    op_s.add_argument("--poll-interval", type=float, default=1.5)
    op_s.add_argument("--json", action="store_true")

    op_c = sub.add_parser("op-classify")
    op_c.add_argument("topic")
    op_c.add_argument("query_id")
    op_c.add_argument("--top-k", type=int, default=20)
    op_c.add_argument("--sort", default="RelevanceScore")
    op_c.add_argument("--provider", default="zai")
    op_c.add_argument("--model", default="glm-4.5-flash")
    op_c.add_argument("--thinking", default="off")
    op_c.add_argument("--max-workers", type=int, default=2)
    op_c.add_argument("--batch-size", type=int, default=5)
    op_c.add_argument("--json", action="store_true")

    op_g = sub.add_parser("op-grow")
    op_g.add_argument("seeds", help="Comma-separated DOI/paper_id seeds")
    op_g.add_argument("--levels", type=int, default=2)
    op_g.add_argument("--limit-per-node", type=int, default=30)
    op_g.add_argument("--mock", action="store_true")
    op_g.add_argument("--json", action="store_true")

    m = sub.add_parser("mine")
    m.add_argument("query")
    m.add_argument("--search-top-k", type=int, default=16)
    m.add_argument("--min-seed-count", type=int, default=16)
    m.add_argument("--crossref-rows", type=int, default=40)
    m.add_argument("--grow-limit-per-node", type=int, default=20)
    m.add_argument("--round2-top-k", type=int, default=12)
    m.add_argument("--pool-bias-strength", type=float, default=0.8)
    m.add_argument("--seed-init-boost", type=float, default=3.0)
    m.add_argument("--seed-pool-factor-floor", type=float, default=0.06)
    m.add_argument("--seed-rescue-max", type=int, default=8)
    m.add_argument("--anchor-score-boost", type=float, default=4.0)
    m.add_argument("--backfill-limit-round1", type=int, default=4000)
    m.add_argument("--backfill-limit-round2", type=int, default=6000)
